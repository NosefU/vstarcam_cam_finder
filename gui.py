...
class CameraWidget:
    def __init__(self, root_widget, camera):
        ...
        self.ip_label = tk.Label(self.ip_frame, text='IP', width=7, anchor=tk.E)
        ...
        self.cloud_label = tk.Label(self.cloud_frame, text='Cloud ID', width=7, anchor=tk.E)
...
cam_widget.pack(pady=10)
cam_widget2.pack(pady=10)
cam_widget3.pack(pady=10)
cam_widget4.pack(pady=10)
